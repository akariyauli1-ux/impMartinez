...
<div class="card">
    ...
    <form method="GET" action="<?= APP_URL ?>/public/rrhh/inspecciones" style="display: flex; gap: 15px; flex-wrap: wrap; align-items: end;">
        ...
        <table>
            ...
            <tbody>
                <?php if (empty($inspecciones)): ?>
                    <tr>
                        <td colspan="10" style="text-align: center; padding: 20px; color: var(--gris);">
                ...
                <?php else: ?>
                    <?php foreach ($inspecciones as $i): ?>
                        <tr>
                            ...
                            <td><?= $i['hora_revision_limpieza'] ?? '-' ?></td>
                            <td><?= htmlspecialchars($i['obs_limpieza'] ?? '-') ?></td>
                            <td>
                                <?php
                            ...
                            <td><?= $i['hora_revision_uniforme'] ?? '-' ?></td>
                            <td><?= htmlspecialchars($i['obs_uniforme'] ?? '-') ?></td>
